<?php
/** inheritence -> proses pewarisan atribut dan method dari superclass ke sub class */
class Lingkaran{
    /** atribut */
    public $r;
...
{
    public $tinggi;
    /** keyword parent digunakan utk mengakses atribur atau method dari superclass */
    ...
    {
        // 2*phi*r * (r+t)
        return 2 * 3.14 * ($this->r + $this->tinggi);
    }
